...
describe('KinetixV2Factory', () => {
  ...
  async function createPair(tokens: [string, string]) {
    const bytecode = `0x${KinetixV2Pair.evm.bytecode.object}`
    ...
    const pair = new Contract(create2Address, JSON.stringify(KinetixV2Pair.abi), provider)
